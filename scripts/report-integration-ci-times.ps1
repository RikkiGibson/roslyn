...
$priorities = @{
    VS_Integration_Debug_64 = 1;
    VS_Integration_Release_32 = 1
}
...
$prerequisites = @{
    "1_VS_Integration_Debug_64"   = $null;
    "1_VS_Integration_Release_32" = $null;
}
...
$outDir = Join-Path $ArtifactsDir "integration-ci-times.csv"
