...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal readonly struct MethodGroupResolution
    {
        ...
        {
            Debug.Assert((methodGroup != null) || (otherSymbol is not null) || analyzedArguments == null); // analyzedArguments is only set if we have some result
        ...
        [MemberNotNullWhen(true, nameof(MethodGroup))]
