...
class C
{
    ...
    bool M(out int x) { x = 42; return true; }
}
";
            CreateCompilation(source).VerifyDiagnostics(
...
class C
{
    ...
    C MA() { return this; }
    bool MB(out int x) { x = 42; return true; }
}
";
            CreateCompilation(source).VerifyDiagnostics(
                // (8,15): error CS0165: Use of unassigned local variable 'x'
...
";
        ...
        [InlineData("true")]
        [InlineData("false")]
        public void EqualsNullCoalescing_01(string operand)
        {
            var source = @"
#nullable enable
...
";
        ...
        [InlineData("i")]
        [InlineData("42")]
        public void EqualsNullCoalescing_02(string operand)
        {
            var source = @"
#nullable enable
...
";
        ...
        [InlineData("int?")]
        [InlineData("bool?")]
        public void EqualsNullCoalescing_03(string returnType)
        {
            var source = @"
#nullable enable
...
";
        ...
        [Fact]
        public void EqualsNullCoalescing_04()
        {
            var source = @"
#nullable enable
...
";
        ...
        [Fact]
        public void EqualsNullCoalescing_05()
        {
            var source = @"
#nullable enable
...
";
        ...
        // TODO: we need to remove certain conversions from operands to "realize" that they contain conditional accesses
        [Fact]
        public void EqualsNullCoalescing_06()
        {
            var source = @"
#nullable enable
