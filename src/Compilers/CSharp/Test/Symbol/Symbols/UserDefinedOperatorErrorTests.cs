...
";
            ...
            comp = CreateCompilation(text, parseOptions: TestOptions.Regular12);
            comp.VerifyDiagnostics(
                // (4,5): error CS8652: The feature 'relaxed ordering of ref and partial modifiers' is currently in Preview and *unsupported*. To use Preview features, use the 'preview' language version.
                //     partial public static int operator + (C c1, C c2) { return 0; }
                Diagnostic(ErrorCode.ERR_FeatureInPreview, "partial").WithArguments("relaxed ordering of ref and partial modifiers").WithLocation(4, 5),
