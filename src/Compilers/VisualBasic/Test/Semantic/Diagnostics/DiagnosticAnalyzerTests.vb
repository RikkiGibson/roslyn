...
End Class
            ...
            Dim compilation = CreateCompilationWithMscorlib45(trees.ToArray(), {SystemRef}, TestOptions.ReleaseDll)
            compilation.VerifyDiagnostics()
...
End Class")
        ...
        Private NotInheritable Class MySemanticModelProvider
            ...
            Public Overrides Function GetSemanticModel(tree As SyntaxTree, compilation As Compilation, options As SemanticModelOptions) As SemanticModel
