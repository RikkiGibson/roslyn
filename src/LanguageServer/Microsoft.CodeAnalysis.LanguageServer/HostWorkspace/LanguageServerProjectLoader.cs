...
internal abstract class LanguageServerProjectLoader
{
    ...
    protected async ValueTask<ProjectId?> TryBeginLoadingProjectWithPrimordialAsync(string projectPath, ProjectSystemProjectFactory primordialProjectFactory, Func<ProjectSystemProjectFactory, ProjectId> createPrimordialProject, bool doDesignTimeBuild)
    {
        using (await _gate.DisposableWaitAsync(CancellationToken.None))
        {
            ...
            var primordialProjectId = createPrimordialProject(primordialProjectFactory);
